    ...
    return(
        ...
        >
            ...
            <div className="flex gap-4 text-xl">
                ...
                <a href="https://github.com/SaranLilly/vitereact" target="_blank" className="hover:scale-110"><FontAwesomeIcon icon={faGithub}/></a>
                <a href="https://github.com/SaranLilly/vitereact" target="_blank" className="hover:scale-110"><FontAwesomeIcon icon={faMedium}/></a>
                <a href="https://github.com/SaranLilly/vitereact" target="_blank" className="hover:scale-110"><FontAwesomeIcon icon={faYoutube}/></a>
